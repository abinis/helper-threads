...
//changing that to bitmask implementation
//extern char *edge_color_main;
extern bitmask_t *edge_color_main;
                         ...
                         char **edge_color_helper*/)
{
    ...
    */
    *edge_color_main = edge_color_bitmask_init(el->nedges);
    ...
    */
    ...
    /* Already set to 0 by edge_color_bitmask_init!
...
void kruskal_helper_destroy(bitmask_t *edge_color_main)
{
    ...
    edge_color_bitmask_destroy(edge_color_main);
}
...
void *kruskal_ht(void *args)
{
    ...
    if ( thread_type == MAIN_THR ) {
        ...
        for ( i = begin; i < end; i++ ) {
            ...
            if( edge_color_bitmask_get_color(edge_color_main,i) != 0 ) {
                ...
                if ( set1 != set2 ) {
                    ...
                    //Replaced function call with function body
                    edge_color_bitmask_set_color(edge_color_main, i);
                    //unsigned int cellno = i / edge_color_main->cell_size;
                    //unsigned int offset = i % edge_color_main->cell_size;
                    //offset = edge_color_main->cell_size - offset;

                    ////TODO bitwise set bit in position offset!
                    //unsigned char bit = 1U << (offset-1);
                    //edge_color_main->bitmask[cellno] |= bit;
                }
            }
        }   
        main_finished = 1;
