    ...
    // Helper Threads
        ...
        while ( i >= end ) {
            ...
            //if ( edge_color_main[i] == 0 ) {
                ...
                if ( set1 == set2 ) {
                   /*ht_cycles_found += (*/ __sync_bool_compare_and_swap(&(pe->edge_color), 0, id + 1) /*) ? 1 : 0*/;
